    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <h3 id="lg3" style="font-size: 15px; text-align:right;">
                ...
                <p style="text-align: justify; margin-left: 10px;"><b><i>A játék története: </i></b></p>
        ...
        <div class="col-lg-12">
            <h3 id="lg3" style="font-size: 15px; text-align:right;">
                ...
                <p style="text-align: justify; margin-left: 10px;"><a href="https://hu.wikipedia.org/wiki/1895">1895.</a> <a href="https://hu.wikipedia.org/wiki/Febru%C3%A1r_9.">február 9-én</a> a massachusettsi Holyoke városában egy testnevelési igazgató, William G. Morgan megalkotott egy új szabadidős játékot <i style="color: red;">mintonette</i> néven, felhasználva a tenisz és a kézilabda egyes elemeit is. Ezt főleg teremben lehetett játszani, korlátlan számú résztvevővel, és eredetileg a YMCA (Fiatal Katolikus Férfiak Szövetsége) korosabb, de mégis atletikus beállítottságú tagjainak tervezték a túlságosan is erőszakosnak tartott kosárlabda helyett (ami egyébként mindössze négy évvel korábban és 16 kilométerrel arrébb, a szomszédos Springfieldben alakult ki). A Mintonette végül röplabda néven terjedt el, beltéri és szabadtéri változatban egyaránt.</p>
                <p style="text-align: justify; margin-left: 10px; margin-right: 10px;">A William G. Morgan által papírra vetett első szabályok a háló méretét 1,98 méterben (6 láb és 6 hüvelyk), a pálya méretét pedig 7,6×15,2 méterben (25×50 láb) határozták meg, a játékosok számát azonban nem korlátozták. A meccs kilenc labdamenetből állt, három nyitással mindkét oldalon, és mindkét csapat korlátlanul érinthette a labdát, mielőtt átütötte volna azt az ellenfél térfelére. Szervahiba esetén engedélyezett egy második próbálkozás, de ha a labda fennakadt a hálón, úgy az ellenfél kapott pontot – kivéve, ha ez az első szervapróbálkozásnál történt meg. A hölgyek – ujjaik védelmében – megfoghatták, majd visszadobhatták a labdát.</p>
                <img src="kepek/vollayball/images (1).jpg" style="float:left; margin-left: 10px; margin-bottom: 5px; margin-right: 10px; border: solid black 1px; padding: 2px;">
                <p style="text-align: justify; margin-left: 10px;">A William G. Morgan által papírra vetett első szabályok a háló méretét 1,98 méterben (6 láb és 6 hüvelyk), a pálya méretét pedig 7,6×15,2 méterben (25×50 láb) határozták meg, a játékosok számát azonban nem korlátozták. A meccs kilenc labdamenetből állt, három nyitással mindkét oldalon, és mindkét csapat korlátlanul érinthette a labdát, mielőtt átütötte volna azt az ellenfél térfelére. Szervahiba esetén engedélyezett egy második próbálkozás, de ha a labda fennakadt a hálón, úgy az ellenfél kapott pontot – kivéve, ha ez az első szervapróbálkozásnál történt meg. A hölgyek – ujjaik védelmében – megfoghatták, majd visszadobhatták a labdát.</p>
                <p style="text-align: justify; margin-left: 10px; margin-right: 10px;">A springfieldi YMCA-ban játszott 1896-os bemutatómeccsen az egyik néző, bizonyos Alfred Halsteadet megihlette a játék „röpködő természete” – tőle ered a röplabda név. Ezt követően a springfieldi YMCA kissé módosította a játék szabályait, majd elküldte azt a többi YMCA-nek is országszerte. 1947-ben alakult meg a Fédération Internationale de Volleyball (FIVB), a röplabdajátékokat szervező nemzetközi szövetség. 1949-ben bonyolították le az első férfi, majd 1952-ben az első női bajnokságot. 1964-ben bekerült az olimpiai játékok sportágai közé, aminek azóta is részét képezi.</p>
