...
<div class="container-fluid">       
      <div class="row">
          <div class="card" style="width:400px">
            <h4 class="card-title">1. Szoboszlai Dominik</h4>
          ...
          <div class="card" style="width:400px">
            <h4 class="card-title">2. Szalai Ádám</h4>
          ...
          <div class="card" style="width:400px">
            <h4 class="card-title">3. Dzsudzság Balázs</h4>
          ...
          <div class="card" style="width:400px">
            <h4 class="card-title">4. Puskás Ferenc</h4>
          ...
          <div class="card" style="width:400px">
            <h4 class="card-title">5. Nagy Ádám</h4>
          ...
          <div class="card" style="width:400px">
            <h4 class="card-title">6. Mátrai Sándor</h4>
          ...
          <div class="card" style="width:400px">
            <h4 class="card-title">7. Sándor Károly</h4>
          ...
          <div class="card" style="width:400px">
            <h4 class="card-title">8. Sipos Ferenc</h4>
          ...
          <div class="card" style="width:400px">
            <h4 class="card-title">9. Fenyvesi Máté</h4>
          ...
          <div class="card" style="width:400px">
            <h4 class="card-title">10. Albert Flórián</h4>
          ...
          <div class="card" style="width:400px">
            <h4 class="card-title">11. Lang Ádám</h4>
          ...
          <div class="card" style="width:400px">
            <h4 class="card-title">12. Kalmár Zsolt</h4>
          ...
          <div class="card" style="width:400px">
            <h4 class="card-title">13. Kata Mihály</h4>
          ...
          <div class="card" style="width:400px">
            <h4 class="card-title">14. Botka Endre</h4>
          ...
          <div class="card" style="width:400px">
            <h4 class="card-title">15. Fiola Attila</h4>
          ...
          <div class="card" style="width:400px">
            <h4 class="card-title">16. Kerkez Milos</h4>
          ...
          <div class="card" style="width:400px">
            <h4 class="card-title">17. Bene Ferenc</h4>
          ...
          <div class="card" style="width:400px">
            <h4 class="card-title">18. Horváth Krisztofer</h4>
          ...
          <div class="card" style="width:400px">
            <h4 class="card-title">19. Bálint László</h4>
          ...
          <div class="card" style="width:400px">
            <h4 class="card-title">20. Vanczák Vilmos</h4>
          ...
          <div class="card" style="width:400px">
            <h4 class="card-title">21. Garaba Imre</h4>
