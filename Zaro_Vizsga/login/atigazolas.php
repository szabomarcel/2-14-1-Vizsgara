...
<div class="container-fluid">  
  ...
  <div class="row">
      <div class="card" style="width:400px">
        <h4 class="card-title" id="SZD">1. Szoboszlai Dominik</h4>
        <a href="kepek/Szoboszlai_Dominik.jpg"><img class="card-img-top" src="kepek/Szoboszlai_Dominik.jpg" alt="Szoboszlai Dominik" title="Szoboszlai Dominik"/></a>
        <div class="card-body">
          <p class="card-text">2023 nyara jelentős mérföldkő volt a magyar válogatott csapatkapitánya, Szoboszlai Dominik számára. A korábbi találgatásoktól eltérő eredményt hozott az átigazolási szezon, a Premier League-ben szereplő élcsapat, a Liverpool igen magas, 70 millió eurós összeget fizetett érte korábbi egyesületének, az RB Leipzignek – írja elemzésében az Oeconomus Gazdaságkutató Alapítvány. Ezzel a tranzakcióval Szoboszlai Dominik toronymagasan vezeti a legnagyobb összegért csapatot váltó magyar labdarúgók listáját. Felmerül a kérdés, vajon mennyit is ér ez a szám a foci világában? Egyáltalán mit jelent egy játékos értéke? Az elemzés ezekre a kérdésekre keresi a választ.</p><br>
          <p><b>A magyar válogatott labdarúgó vételi árát több összehasonlításban is vizsgálja, így például a korábbi és jelenleg is aktív magyar játékosok tranzakciós értéke, egykori és mai áron számítva, továbbá nemzetközi összehasonlításban, például az idei klubcserék tükrében.</b></p><br>
          <p><i>A játékos piaci értékét a futballban különböző tényezők alapján kalkulálják. Ide tartoznak sportoló pályán mutatott készségei és képességei, életkora, nemzetisége. Számít a bajnokság amiben játszik, a szerződéses státusa és olyan külső tényezők, mint a sérülései vagy a pályán kívüli vitás ügyei.</i></p><br>
          <p>Szoboszlai Dominik 2023-as 70 millió eurós, RB Leipzigtól a Liverpoolba történő átigazolásával lényegében saját rekordját döntötte meg. Korábban, 2021-ben 22 millió eurós vételárral ment az RB Salzburgtól az RB Leipzigbe. A harmadik Dzsudzsák Balázs 2012-es csapatváltása, amikor 19 millió euróért igazolt az Anzsi Mahacskalától a Dinamo Moszkvába. Míg ezt megelőző igazolása 14 millió eurót ért 2011-ben a PSV-től az Anzsi Mahacskalához. Détári Lajos 1988-ban német márkáról átszámítva 8,7 millió euróért váltott az Eintracht Frankfurttól és a Budapest Honvédtól az Olympiakoszhoz.</p>
        </div>
      </div>
      <div class="card" style="width:400px">
        <h4 class="card-title"id="SZA">2. Szalai Ádám</h4>
        <a href="kepek/Szalai_Adam.jpg"><img class="card-img-top" src="kepek/Szalai_Adam.jpg" alt="Szalai Ádám" title="Szalai Ádám"></a>
        <div class="card-body">
      ...
      <div class="card" style="width:400px">
        <h4 class="card-title" id="DZSB">3. Dzsudzság Balázs</h4>
        <a href="kepek/Dzsudzsal_Balazs.jpg"><img class="card-img-top" src="kepek/Dzsudzsal_Balazs.jpg" alt="Dzsudszák Balázs" title="Dzsudszák Balázs"></a>
        <div class="card-body">
          <p class="card-text"><p class="card-text">Sajtótájékoztatót tartottak.</p><br>
          <p>Sajtótájékoztatót tartott pénteken a DVSC, mégpedig a csapat jövőjét igencsak meghatározó témákat érintve. Az eseményen Makray Balázs cégvezető hivatalosan is bemutatta az új vezetőedzőt, a portugál Joao Janeirót, valamint a klub új klubigazgatóját, az örmény Hayk Hovakimyant. A tájékoztatón kiderült az is, hogy Dzsudszák Balázs marad az együttesnél, valamint, hogy edzőtábor is van tervezve a nyári felkészülésbe. Mindezekről a klub hivatalos oldalán számolt be. Sajtótájékoztatót tartottak. </p><br>
          <p>A klubigazgató bejelentette, hogy játékoskeret kialakítása még folyamatban van, de az már biztos, Dzsudzsák Balázs a Lokiban folytatja pályafutását. A további döntések a jövő hét elején válnak majd nyilvánossá.</p><br>
          <p>Az 1+1 évre szerződött Joao Janeiro vezetőedző arról beszélt, büszke arra, hogy a Debrecent, egy ilyen sikeres klubot képviselhet. Szerinte nagyon ritka, hogy ilyen sok saját nevelésű játékos szerepel egy futballcsapatban, mint a DVSC-ben, és ezt szeretné fenntartani. – A jó nem elég, a maximumra van szükség – szögezte le a tréner, aki teljes erőbedobást vár magától és a csapattól is”.</p></p>
        </div>
      </div>
      <div class="card" style="width:400px">
        <h4 class="card-title" id="PF">4. Puskás Ferenc</h4>
        <a href="kepek/Puskas_Ferenc.jpg"><img class="card-img-top" src="kepek/Puskas_Ferenc.jpg" class="card-img-top" alt="Puskás Ferenc" title="Puskás Ferenc"></a>
        <div class="card-body">
          <p class="card-text"><i>2006-ban ezen a napon született a Nemzet Sportolója címmel kitüntetett, olimpiai arany- és világbajnoki ezüstérmes Puskás Ferenc. A  világ valaha volt legjobbjainak egyike olyat alkotott, amit talán sosem felejtenek majd el az emberek. Nem csak remek focista, hanem ikon is volt, akire mindmáig gyerekek ezrei szeretnének hasonlítani.Az Öcsiként is ismert labdarúgó 1927. április elsején látta meg a napvilágot. Édesapja hatására hamar futballozni kezdett, és bár sokszor csak rongyból készült labdára telt családjának, ő rendíthetetlenül gyakorolt a közeli grundon.</i></p><br>
          <p>Sokszor fél napig is kergette a labdát a lakásukhoz közeli pályán. Itt ismerte meg Bozsik Józsefet is, akivel olyan erős barátságot kötöttek, hogy amikor a nála másfél évvel idősebb "Cucut" leigazolták a Kispestiek, ő addig könyörgött az edzőnek, míg hamis papírokkal fel nem vették őt is.</p><br>
          <p><b>16 évesen aztán már a felnőtteknél rúgta a bőrt, és ettől kezdve neve összefort a Honvéddal. 14 éven keresztül, 341 mérkőzésen lépett pályára kispesti színekben és ezalatt 352 gólt szerzett.</b></p>
        </div>
      </div>
      <div class="card" style="width:400px">
        <h4 class="card-title" id="NA">5. Nagy Ádám</h4>
        <a href="kepek/Nagy_Adam.jpg"><img class="card-img-top" src="kepek/Nagy_Adam.jpg" alt="Nagy Ádám" title="Nagy Ádám"></a>
        <div class="card-body">
      ...
      <div class="card" style="width:400px">
        <h4 class="card-title" id="MS">6. Mátrai Sándor</h4>
        <a href="kepek/Matrai_Sandor.jpg"><img class="card-img-top" src="kepek/Matrai_Sandor.jpg" alt="Mátrai Sándor" title="Mátrai Sándor"></a>
        <div class="card-body">
          <p class="card-text"><em>A labdarúgó NB I-ben szereplő Ferencváros hivatalos honlapján tudatta, hogy nem vezettek eredményre a Benficával folytatott tárgyalások Csoboth Kevin átigazolása kapcsán, így a zöld-fehérek a megoldás érdekében a FIFA vitarendező szervéhez fordulnak. 
            Emellett az FTC „fiktív átigazolás gyanúja miatt” a következő napokban büntetőfeljelentést tesz csalás, valamint okirat-hamisítás ügyében.</em></p><br>            
          <p><b><i>Csoboth Kevin 2016 szeptemberében a portugál Benficához szerződött, a Ferencváros U16-os csapatában a 2015–2016-os szezonban 15 mérkőzésen 30 gólt szerző futballista az MLSZ adatbázisa szerint júliusban a Kozármislenyhez igazolt, ám az NB II-es klub erről nem adott tájékoztatást.
            Mint ismert, 2016 nyarán profi szerződést ajánlott neki a Ferencváros, de Csoboth nemet mondott a zöld-fehéreknek, majd ezek után Kozármislenyre került, az út onnan vezetett Lisszabonba.
            Hogy pontosan mi állhatott a háttérben, nem lehetett tudni, ugyanakkor az ask.fm nevű közösségi oldalon Csoboth 2016 augusztusában az egyik kérdésre adott válaszában arra utalt, azért szerződött a Kozármislenyhez, mert onnan könnyebben igazol a határon túlra, mint az Üllői útról. Állítása szerint: „a Fradiból nem engedtek külföldre”.</i></b></p>
        </div>
      </div>
      <div class="card" style="width:400px">
        <h4 class="card-title" id="SK">7. Sándor Károly</h4>
        <a href="kepek/Sandor_Karoly.jpg"><img class="card-img-top" src="kepek/Sandor_Karoly.jpg" alt="Sándor Károly" title="Sándor Károly"></a>
        <div class="card-body">
      ...
      <div class="card" style="width:400px">
        <h4 class="card-title" id="SF">8. Sipos Ferenc</h4>
        <a href="kepek/Sipos_Ferenc.jpg"><img class="card-img-top" src="kepek/Sipos_Ferenc.jpg" alt="Sipos Ferenc" title="Sipos Ferenc"></a>
        <div class="card-body">
      ...
      <div class="card" style="width:400px">
        <h4 class="card-title" id="FM">9. Fenyvesi Máté</h4>
        <a href="kepek/Fenyvesi_Mate.jpg"><img class="card-img-top" src="kepek/Fenyvesi_Mate.jpg" alt="Fenyvesi Máté" title="Fenyvesi Máté"></a>
        <div class="card-body">
          <p class="card-text"><i>88 éves korában meghalt Fenyvesi Máté, az FTC egykori kiváló, válogatott labdarúgója, sportvezetője, a klub örökös bajnoka.</i></p><br>
          <p><b>Fenyvesi Máté Jánoshalmán született 1933. szeptember 19-én, s a Kecskeméti Kinizsin keresztül vezetett az útja a Fradiba, igaz a Honvéd is csábította. 1953-ban debütált az FTC-ben, amelyet akkor még Budapesti Kinizsinek neveztek.</b></p><br>
          <p>1954 szeptemberében debütált az Aranycsapatban Románia ellen. Nem volt könnyű helyzetben, ez volt a válogatott első mérkőzése az elvesztett világbajnoki döntő.</p><br>
          <p>Első sikere klubunkkal a 1958-as Magyar Népköztársasági-kupa megnyerése volt, amelyet a hatvanas években négy bajnoki cím követett (1963, 1964, 1967 és 1968), valamint a VVK-diadal.</p>
        </div>
      </div>
      <div class="card" style="width:400px">
        <h4 class="card-title" id="AF">10. Albert Flórián</h4>
        <a href="kepek/Albert Florian.jpg"><img class="card-img-top" src="kepek/Albert Florian.jpg" alt="Albert Flórián" title="Albert Flórián" ></a>
        <div class="card-body">
          <p class="card-text">Vágó Fanny távozott a bajnoki címvédő Ferencváros női labdarúgócsapatának vezetőedzői posztjáról, a helyét Albert Flórián vette át.</p><br>
          <p><b>Az FTC-Telekom a múlt héten nem jutott tovább a Bajnokok Ligája-selejtező gyulafehérvári csoportjából, ezt követően került sor az edzőváltásra – adta hírül szerdán a zöld-fehér klub honlapján.</b></p><br>
          <p>Az aranylabdás klublegenda Albert Flórián fia tagja volt az 1995-ben BL-főtáblás Ferencvárosnak, edzői pályafutását a klub utánpótlásában kezdte, majd Gellei Imre pályaedzője lett a felnőtt csapatnál. Egy dunaújvárosi kitérő után visszatért az utánpótlás élére, ezt követően a magyar szövetség kötelékében, majd a Tökölnél, a Budaörsnél, a Soroksárnál, legutóbb pedig a BKV Előrénél dolgozott. A női labdarúgásban ez az első megbízása.</p><br>
          <p><i>Vágó Fanny 2019 nyarán igazolt a Fradiba, aminek 2021 szeptembere óta játékos-edzője volt, és most futballistaként is távozott a klubtól.</i></p>
        </div>
      </div>
      <div class="card" style="width:400px">
        <h4 class="card-title" id="LA">11. Lang Ádám</h4>
        <a href="kepek/Lang_Adam.jpg"><img class="card-img-top" src="kepek/Lang_Adam.jpg" alt="Lang Ádám" title="Lang Ádám"></a>
        <div class="card-body">
      ...
      <div class="card" style="width:400px">
        <h4 class="card-title" id="KZS">12. Kalmár Zsolt</h4>
        <a href="kepek/Kalmar_Zsolt.jpg"><img class="card-img-top" src="kepek/Kalmar_Zsolt.jpg" alt="Kalmár Zsolt" title="Kalmár Zsolt"/></a>
        <div class="card-body">
          <p class="card-text">Bejelentették Kalmár Zsolt érkezését
            ...
            32-szeres válogatott középpályás, aki meghatározó játékosa volt a Dunaszerdahelyi AC együttesének, kettő plusz egy évre szóló szerződést írt alá a székesfehérvári klub honlapjának pénteki közlése szerint. Minden további részlet, és a játékos nyilatkozata alább!</p><br>
          <p>Köszönjük olvasóink figyelmét!
            Búcsúzik a hétre a Futballbazár, igen eseménydús napot zártunk az átigazolási piacon. Volt itt minden, de leginkább a Harry Kane és Moises Caicedo körüli események kavarták fel az állóvizet. 
            Legközelebb hétfőn jelentkezünk percről percre frissülő hírfolyammal, amelyben összefoglaljuk a szombat és a vasárnap legfontosabb eseményeit. Szép hétvégét kívánunk.</p><br>
          <p>Újabb taggal bővülhet a Börtön FC?
      ...
      <div class="card" style="width:400px">
        <h4 class="card-title" id="KM">13. Kata Mihály</h4>
        <a href="kepek/Kata_Mihaly.jpg"><img class="card-img-top" src="kepek/Kata_Mihaly.jpg" alt="Kata Mihály" title="Kata Mihály"></a>
        <div class="card-body">
      ...
      <div class="card" style="width:400px">
        <h4 class="card-title" id="BE">14. Botka Endre</h4>
        <a href="kepek/Botka_Endre.jpg"><img class="card-img-top" src="kepek/Botka_Endre.jpg" alt="Card image"></a>
        <div class="card-body">
          <p class="card-text">
      ...
      <div class="card" style="width:400px">
        <h4 class="card-title" id="FA">15. Fiola Attila</h4>
        <a href="kepek/Fiola_Attila.jpg"><img class="card-img-top" src="kepek/Fiola_Attila.jpg" alt="Fiola Attila" title="Fiola Attila"></a>
        <div class="card-body">
          <p class="card-text"><b>Mi vár Fehérváron az újpesti igazolásokra? 23 érkezőből összesen 5 vált be, avagy Fiola esete nagyon ritka</b></p><br>
          <p><em>A MOL Fehérvár az átigazolási időszak utolsó napján Csongvai Áron és Katona Mátyás személyében két játékost is szerződtetett az Újpesttől. A transzfer komoly érzelmeket váltott ki mindkét klub szurkolóinál, sokakban felmerült a kérdés, hogy a két tehetséges fiatal valóban felfelé lépett-e. A labdarúgók mindenesetre abszolút így tekintenek a transzferre, hiszen a Vidinél az elmúlt időszak gyengébb teljesítménye ellenére is mások a lehetőségek, mint a lila-fehéreknél voltak.</em></p><br>
          <p>Mivel Fehérváron az elmúlt években megszokottá vált, hogy hazai kluboktól szerződtetnek játékosokat, így honlapunk a két friss átigazolás apropóján megnézte, milyen arányban válnak be ezek az üzletek a Vidinél. Addig az évig (2016-ig) mentünk vissza, amikor a legjobb üzletet kötötték a fehérváriak Fiola Attila megszerzésével.</p><br>
          <p><b>Amint azonban az az alábbi, részletes felsorolásból is látszik, Fiola példája igen ritka, 23 érkezőből rajta kívül csak Adrian Rus, Kovács Dániel, Bolla Bendegúz és Varga József megszerzése, amire azt lehet mondani, hogy bevált igazolás volt.</b></p>
        </div>
      </div>
      <div class="card" style="width:400px">
        <h4 class="card-title" id="KM">16. Kerkez Milos</h4>
        <a href="kepek/Kerkesz_Milos.jpg"><img class="card-img-top" src="kepek/Kerkesz_Milos.jpg" alt="Kerkez Milos" title="Kerkez Milos"></a>
        <div class="card-body">
      ...
      <div class="card" style="width:400px">
        <h4 class="card-title" id="BF">17. Bene Ferenc</h4>
        <a href="kepek/Bene_Ferenc.jpg"><img class="card-img-top" src="kepek/Bene_Ferenc.jpg" alt="Bene Ferenc" title="Bene Ferenc"></a>
        <div class="card-body">
          <p class="card-text"><b>Az NB II-ben szereplő Vasas decemberben kinevezett új vezetőedzője, ifjabb Bene Ferenc az M4 Sport vadonatúj, Átigazolás című műsorában elmondta, az egyesület célja egy nyugat-európai klubmodell kidolgozása, valamint egy olyan csapat felépítése, amely legkésőbb jövőre fel tud jutni az NB I-be.</b></p><br>
          <p><i>„Célunk visszakerülni az NB I-be, de a lemaradásunk tetemes, így senkire nem helyezünk nyomást és nem szabad a szurkolókat sem becsapni. Közép és hosszú távra tervezünk, minden posztra specialistákat igazolunk, értem ez alatt a szakmai stábot és a játékosokat is, és természetesen szeretnénk az akadémiáról is beépíteni a fiatalokat. <b>A cél, hogy minimum fél év alatt felépítsünk egy olyan ütőképes csapatot, amely legrosszabb esetben jövőre vissza tud jutni az élvonalba”</b></i> – mondta a Merkantil Bank Liga 8. helyén telelő csapat 41 éves mestere.</p><br>
          <p><i>- Elsősorban szeretném megköszönni Krisztofernek, az ő képviselőinek, és a Torinónak a szakszerűséget és a közreműködést ehhez az egyezményhez. További sikereket és sérülésmentes karriert kívánunk Krisztofernek! Ugyanakkor sajnálom, hogy a hivatalos bejelentés előtt elterjedt a hír Krisztofer átigazolásáról. A jogi eljárásokat követnünk kell és szigorúan be kell tartanunk, mielőtt bejelentést teszünk. Arra kérem a szurkolóinkat, hogy kövessék a DVSC hivatalos csatornáit, és az ott megjelent információt tekintsék kézzel foghatónak</i> - fogalmazott.</p><br>
          <p>Horváth klubváltása az elmúlt napokban már sejthető volt, hiszen a DVSC - már csak volt - támadója nem utazott el csapata törökországi edzőtáborába, helyette egy másik NB I-es gárdával, az OTP Bank Liga második helyén telelő Kecskeméttel indult útnak Belekbe, sőt, <a href="https://www.csakfoci.hu/magyar-foci/nb-i-a-serie-a-csapat-magyar-tamadoja-a-dobogos-kezdojeben-tunt-fel-az-edzomeccsen">már egy hete pályára lépett lila-fehérben.</a></p>
        </div>
      </div>
      <div class="card" style="width:400px">
        <h4 class="card-title" id="HK">18. Horváth Krisztofer</h4>
        <a href="kepek/Horvath_Krisztofer.jpg"><img class="card-img-top" src="kepek/Horvath_Krisztofer.jpg" alt="Horváth Krisztofer" title="Horváth Krisztofer"></a>
        <div class="card-body">
          <p class="card-text">Kedden hivatalossá vált, hogy közös megegyezéssel megszűnt <b>Horváth Krisztofer</b> debreceni kölcsönszerződése. A 21 éves futballista az olasz Torino kölcsönjátékosaként tavaly augusztusban érkezett a DVSC-hez, melynek színeiben 7 első osztályú bajnokin lépett pályára, a kupában pedig 2 mérkőzésen 1 gólt ért el - írja a dvsc.hu.</p><br>
          <p><b>Hayk Hovakimyan</b>, a DVSC klubigazgatója így nyilatkozott az U21-es válogatott játékos búcsúja kapcsán:</p>
        </div>
      </div>
      <div class="card" style="width:400px">
        <h4 class="card-title" id="BL">19. Bálint László</h4>
        <a href="kepek/Balint_Laszlo.jpg"><img class="card-img-top" src="kepek/Balint_Laszlo.jpg" alt="Bálint László" title="Bálint László"></a>
        <div class="card-body">
          <p class="card-text"><b>Jó hírünket vitte a világban – 75 éves Bálint László, a mindig elegáns „Báró”</b></p>
          <p><b>gazi fradista, aki a szocialista táborból első magyar futballistaként igazolt külföldre. Középső védőként a sportág egyik honi legendája. Jelenleg lovakat tart. A 76-szoros válogatott Bálint László február elsején lett 75 esztendős.</b></p>
          <p><b>– Honnan eredeztethető a lovak szeretete?</b> – A nagyszüleim Kőbányán mezőgazdasággal foglalkoztak, gyerekként a nagyapám rendszeresen magával vitt, így ismertem meg a lovak világát. Néhány évtizeddel ezelőtt az egyik barátom a lányának lovat vett, s mondta, nézzem meg, aztán idővel lovagolni kezdtem, majd elhatároztam, a sajátjaimat lovagolnám, ezért a Szentendrei-szigetre költöztünk. Hat lovat tartottunk, a velük való munka napi feladatot jelent, keretet ad az életemnek. Idővel három kimúlt, újakat már nem akarok.</p>
          <p><b>– Öregszik?</b> – Lehet...</p>
            <p>– Az FTC híres volt remek középső védőiről: Kispéter Mihály, Mátrai Sándor, Páncsics Miklós, majd ön következett. Ennyire jó volt az utánpótlásképzés, vagy így jött össze?</p>
            <p>– Is-is. De szinte csak „kihalásos” alapon lehetett bekerülni, ki kellett várnom a soromat. A felnőttcsapat keretéhez 1967 végén csatlakozhattam, Mátrai akkor távozott az Egyetértésbe, de Páncsics Miklós előttem volt. Ám Lakat Károly magával vitt a csapat 1968. februári közép-amerikai túrájára.</p>
        </div>
      </div>
      <div class="card" style="width:400px">
        <h4 class="card-title" id="VV">20. Vanczák Vilmos</h4>
        <a href="kepek/Vinczak_Vilmos.jpg"><img class="card-img-top" src="kepek/Vinczak_Vilmos.jpg" alt="Vanczák Vilmos" title="Vanczák Vilmos"></a>
        <div class="card-body">
      ...
      <div class="card" style="width:400px">
        <h4 class="card-title" id="GI">21. Garaba Imre</h4>
        <a href="kepek/Garaba_Imre.jpg"><img class="card-img-top" src="kepek/Garaba_Imre.jpg" alt="Garaba Imre" title="Garaba Imre"></a>
        <div class="card-body">
          <p class="card-text"><b>Budapesti Honvéd SE, 1979-1987</b>
            A 21 éves védő tagja volt már a <a href="https://www.magyarfutball.hu/hu/bajnoki-vegeredmeny/44">kispestiek 1980-as bajnokcsapatának</a>, 1987-ig szinte csak sérülése esetén hiányzott a csapatból. Alapember volt a piros-fehérek Andrusch – Sallai, Nagy A., Garaba, Varga – Gyimesi, Sikesdi, Détári – Bodonyi, Dajka, Esterházy (Kovács K.) összeállítású, Komora Imre irányításával sorozatban három bajnoki címet is nyert együttesének. A Honvéddal a négy bajnoki cím mellett 1985-ben MNK-győztes is lett, 1982-ben, a spanyolországi világbajnokság után az MLSZ az Év játékosának választotta.</p>
          <p>A válogatottban Lakat Károly kapitánysága idején, 1980. április 30-án, Kassán, a csehszlovákok ellen mutatkozott be, az első gólját egy bő évvel később, a Puskás Ferenc hazatérése utáni gálameccset követően játszott, angolok elleni világbajnoki selejtezőn lőtte. A legemlékezetesebb találata ellenben egy idegenbeli volt: 1984. január 18-án az ő góljával nyert a magyar csapat Cádizban, a nem egészen fél évvel később Eb-ezüstérmes spanyolok elleni találkozón. Részese volt a Mezey-korszak minden nagy sikerének, egyebek mellett a brazilok 1986-os budapesti legyőzésének, s természetesen az utolsó állomásig százszázalékosan teljesített világbajnoki selejtezőknek. Két vb-n hat mérkőzésen lépett pályára. A válogatottbeli pályafutását 1991. május elsején, Salernóban, az olaszok ellen zárta.</p>
        </div>
      </div>
  </div> 
</div>
